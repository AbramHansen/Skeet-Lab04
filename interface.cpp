...
void Interface::drawBackground(double redBack, double greenBack, double blueBack) const
{
   ...
   glVertex2f((GLfloat)logic.getDimensionsX(), (GLfloat)0.0);
   glVertex2f((GLfloat)logic.getDimensionsX(), (GLfloat)logic.getDimensionsY());
   glVertex2f((GLfloat)0.0, (GLfloat)logic.getDimensionsY());
   ...
   double redBack, double greenBack, double blueBack) const
{
   ...
   GLfloat length = (GLfloat)logic.getDimensionsX();
...
void Interface::drawBullseye(double angle) const
{
   ...
   double distance = logic.getDimensionsX();
   GLfloat x = logic.getDimensionsX() - distance * cos(angle);
   ...
   glVertex2f(logic.getDimensionsX(), 0.0);
   glVertex2f(x, y);
...
void Interface::drawLevel() const
{
   ...
   // status
   drawText(Position(10, logic.getDimensionsY() - 30), score.getText());
   drawText(Position(logic.getDimensionsX() / 2 - 30, dimensions.getY() - 30), time.getText());
   drawText(Position(logic.getDimensionsX() - 110, dimensions.getY() - 30), hitRatio.getText());
}
...
void Interface::drawStatus() const
{
   ...
   if (time.isGameOver())
   {
      ...
      drawText(Position(logic.getDimensionsX() / 2 - 30, logic.getDimensionsY() / 2 + 10),
         "Game Over");
   ...
   else
   {
      ...
      drawText(Position(logic.getDimensionsX() / 2 - 110, logic.getDimensionsY() / 2 - 10),
         sout.str());
   }
}
